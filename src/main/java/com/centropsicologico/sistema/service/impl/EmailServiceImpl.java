...
public class EmailServiceImpl implements EmailService {
        ...
        public void notifyAdminsNewAppointment(Appointment appointment) {
                ...
                String introduction = "Se ha registrado una nueva cita desde el panel administrativo.";
        ...
        public void notifyAdminsNewAppointmentFromLead(
                ...
                String introduction = "Una pre-reserva del portal público fue convertida en cita.";
        ...
        public void sendPasswordResetEmail(
                ...
                if (user == null
                                ...
                                || rawToken.isBlank()) {
                        System.err.println(
                                        "EMAIL BREVO ERROR: Datos incompletos "
                ...
                String resetUrl = normalizeAppWebUrl()
                                + "/reset-password.html?token="
                                + encodedToken;

                String subject = "Restablece tu contraseña | CentroPsico";

                String textContent = buildPasswordResetText(
                                recipientName,
                                resetUrl,
                                expirationMinutes);

                String htmlContent = buildPasswordResetHtml(
                                recipientName,
                                resetUrl,
                                expirationMinutes);

                /*
                 * Nunca se imprime el token ni el enlace completo
        ...
        public void sendPasswordChangedConfirmation(
                ...
                String subject = "Tu contraseña fue actualizada | CentroPsico";
                ...
                String textContent = """
                                ...
                                Si no reconoces esta actividad, comunícate inmediatamente
                                con el administrador del centro psicológico.
        ...
        private String buildPasswordResetText(
                ...
                return """
                                ...
                                El enlace vence en %d minutos y solo puede
                                utilizarse una vez.

                                Si no solicitaste este cambio, ignora este mensaje.
                                Tu contraseña continuará siendo la misma.
                                        ...
                                        <td align="center">
                                            ...
                                            <table width="620"
                                                   ...
                                                   style="
                                                       ...
                                                       border-radius: 18px;
                                                       overflow: hidden;
                                                       box-shadow: 0 12px 34px rgba(15, 76, 129, 0.12);
                                                   ">
                                                ...
                                                <tr>
                                                    ...
                                                    ">
                                                        ...
                                                        <div style="
                                                            ...
                                                            font-size: 13px;
                                                        ">
                                                            Protección y seguridad de tu cuenta
                                                        </div>
                                                ...
                                                <tr>
                                                    <td style="padding: 38px 36px;">
                                                        ...
                                                        ">
                                                            ...
                                                            ignora el mensaje. Tu contraseña
                                                            actual continuará funcionando.
                                                ...
                                                <tr>
                                                    <td style="
                                                        ...
                                                        text-align: center;
                                                    ">
                                                        CentroPsico · Seguridad de la cuenta
                                                        <br>
        ...
        private String buildPasswordChangedHtml(
                        String recipientName) {
                String loginUrl = normalizeAppWebUrl()
                                + "/login.html";
                                        ...
                                        <td align="center">
                                                ...
                                                <tr>
                                                        ...
                                                        <p style="
                                                                ...
                                                                line-height: 1.7;
                                                        ">
                                                                Ya puedes ingresar a CentroPsico
                                                                utilizando tu nueva contraseña.
                                                        </p>
        ...
        private String normalizeAppWebUrl() {
                String normalized = appWebUrl == null
                                ? ""
                                : appWebUrl.trim();
        ...
        private String buildAppointmentHtml(
                ...
                String appointmentId = value(appointment.getId());
                ...
                String status = value(appointment.getStatus());

                String paymentStatus = value(appointment.getPaymentStatus());

                String statusBackground = getStatusBackground(status);

                String statusColor = getStatusColor(status);

                String paymentBackground = getPaymentBackground(paymentStatus);

                String paymentColor = getPaymentColor(paymentStatus);
